...
Linear ARIMA/GARCH may miss regime switches

Extreme tail events may be underestimated

No exogenous variables (macro indicators, sentiment)
...
**ARFIMA models**: Explicit long memory

**Regime-switching GARCH**: Crisis vs. normal

**Asymmetric GARCH**: Leverage effects (GJR-GARCH)

**Machine Learning**: TimeGANs, VAE for nonlinear patterns
:::
::::
